...
var (
	pkg       = flag.String("assert-path", "github.com/peernova-private/testify/assert", "Path to the assert package")
...
var headerTemplate = `/*
* CODE GENERATED AUTOMATICALLY WITH github.com/peernova-private/testify/_codegen
